    ...
    public componentDidMount(): void {
        ...
        core.server.healthCheck(
            ...
            .catch(() => {
                ...
                Modal.error({
                    title: t('cannot-connect-server-title', 'Cannot connect to the server'),
                    className: 'cvat-modal-cannot-connect-server',
                    closable: false,
                    content:
                        <Text>
                            <Trans i18nKey='cannot-connect-server-content'>
        ...
        if (showPlatformNotification()) {
            ...
            Modal.warning({
                title: t('unsupported-platform-title', 'Unsupported platform detected'),
                    ...
                    <>
                        <Row>
                            <Col>
                                <Text>
                                    <Trans
                                        i18nKey='unsupported-platform-content.0'
                        ...
                        <Row>
                            <Col>
                                <Text type='secondary'>
                                    {t('unsupported-platform-content.1', `The operating system is ${os}`, { os })}
                                </Text>
                            </Col>
                        </Row>
                    </>
            ...
            stopNotifications(false);
            Modal.warning({
                title: t('unsupported-features-title', 'Unsupported features detected'),
                className: 'cvat-modal-unsupported-features-warning',
                content: (
                    <Text>
                        <Trans
                            i18nKey='unsupported-features-content'
                            values={{ name, version }}
                        >
...
export default withTranslation('base')(withRouter(CVATApplication));
