...
function ShortcutsSettingsComponent(props: Props): JSX.Element {
    ...
    const { t: tButton } = useTranslation('base', { keyPrefix: 'button' });
        ...
        <div className='cvat-shortcuts-settings'>
            ...
            <Row className='cvat-shortcuts-setting'>
                <Col span={24}>
                    <Alert
                        message={
                            tSettingsShortcuts('warning', 'Shortcut may consist of any combination of modifiers (alt, ctrl, or shift) and one non-modifier at the end. Some key combinations may be reserved by the browser and cannot be overridden in CVAT.')
                        }
                        type='warning'
                        showIcon
                    />
