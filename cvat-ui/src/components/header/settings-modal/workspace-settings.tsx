        ...
        <div className='cvat-workspace-settings'>
            ...
            <Row className='cvat-workspace-settings-text-settings cvat-player-setting'>
                ...
                <Col span={16}>
                    ...
                    >
                        <Select.Option value='id'>{tSettingsWorkspace('text-settings-contents.ID', 'ID')}</Select.Option>
                        <Select.Option value='label'>{tSettingsWorkspace('text-settings-contents.Label', 'Label')}</Select.Option>
                        <Select.Option value='attributes'>{tSettingsWorkspace('text-settings-contents.Attributes', 'Attributes')}</Select.Option>
                        <Select.Option value='source'>{tSettingsWorkspace('text-settings-contents.Source', 'Source')}</Select.Option>
                        <Select.Option value='descriptions'>{tSettingsWorkspace('text-settings-contents.Descriptions', 'Descriptions')}</Select.Option>
                        <Select.Option value='dimensions'>{tSettingsWorkspace('text-settings-contents.Dimensions', 'Dimensions')}</Select.Option>
                    </Select>
                </Col>
            </Row>
            <Row className='cvat-workspace-settings-text-settings cvat-player-setting'>
            ...
            <Row className='cvat-workspace-settings-show-frame-tags cvat-player-setting'>
                <Col span={24}>
                    ...
                    >
                        {tSettingsWorkspace('show-frame-tags', 'Show tags on frame')}
                    </Checkbox>
                </Col>
                <Col span={24}>
