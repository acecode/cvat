...
function HeaderComponent(props: Props): JSX.Element {
    ...
    menuItems.push([(
        ...
        >
            ...
            <Menu.Item icon={<PlusOutlined />} key='create_organization' onClick={() => history.push('/organizations/create')} className='cvat-header-menu-create-organization'>
                {tHeader('Create')}
            </Menu.Item>
